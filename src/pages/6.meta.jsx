          ...
          <section>
            ...
            <ul>
              <li>
                ...
                <dfn>
                  This attribute is used to refer to the name of the property,
                  e.g.
                  <p>
                    <code>
                      name="author"
              ...
              <li>
                ...
                <dfn>
                  You can use Meta Data to re-direct users to different pages
                  e.g.
                  <p>
                    <code>
          ...
          <aside>
            ...
            <div className="meta_item_1">
              <section>
                <h2>Meta Data</h2>{" "}
                <p>
                  The <dfn>Meta Data</dfn> of an HTML document is stored using
                  the &lt;meta&gt; tag, within the &lt;head&gt; tag.{" "}
                </p>{" "}
                <p>
                  Meta Data is data which is contained within a website, but
                  which doesn't affect the appearance of webpages.{" "}
                </p>{" "}
                <p>
                  However, the attributes associated with Meta Data are
                  especially important in regards to Search Engine Optimisation
                  (SEO).{" "}
                </p>{" "}
                <p>
            ...
            <div className="meta_item_2">
              <section>
                ...
                <p>
                  ...
                  - which help facilitate communication between the client and
                  web servers.
                </p>
                <p>
